import{_ as a,p as t,q as p,Z as s,s as n}from"./framework-47a2e622.js";const o={},e=s(`<h2 id="函数" tabindex="-1"><a class="header-anchor" href="#函数" aria-hidden="true">#</a> 函数</h2><h3 id="定义" tabindex="-1"><a class="header-anchor" href="#定义" aria-hidden="true">#</a> 定义</h3><ul><li>Go 语言中，函数的基本组成为：关键字<code>func</code>、函数名、参数列表、返回值、函数体和返回语句</li></ul><div class="language-go" data-ext="go"><pre class="language-go"><code><span class="token keyword">package</span> mymath 
