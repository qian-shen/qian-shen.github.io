import{_ as a,p as t,q as p,Z as s,s as n}from"./framework-47a2e622.js";const o={},e=s(`<h2 id="类型" tabindex="-1"><a class="header-anchor" href="#类型" aria-hidden="true">#</a> 类型</h2><h3 id="布尔类型" tabindex="-1"><a class="header-anchor" href="#布尔类型" aria-hidden="true">#</a> 布尔类型</h3><ul><li>关键字<code>bool</code>，不支持自动或者强制类型转换</li></ul><div class="language-go" data-ext="go"><pre class="language-go"><code><span class="token keyword">var</span> v1 <span class="token builtin">bool</span>
